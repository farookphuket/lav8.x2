...
if(window.pageYOffset>sticky){header_navbar.classList.add("sticky");logo.src='{{asset("img/see-logo.png")}}';}else{header_navbar.classList.remove("sticky");logo.src='{{asset("img/see-logo.png")}}';}
